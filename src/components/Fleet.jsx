    ...
    <main className="min-h-screen bg-[#090f20] text-white">
      <section className="mx-auto max-w-[1280px] px-6 py-20 sm:py-28">
        <motion.div {...reveal} className="text-center">
          ...
          <h1 className="mt-4 text-4xl font-extrabold sm:text-6xl">The Elite Fleet</h1>
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-7 text-slate-400">
            Flagship vehicles configured with priority comfort, pristine sanitization, and
        ...
        <div className="mt-16 grid gap-7 lg:grid-cols-3">
          {vehicles.map(([tag, name, seats, bags, image], i) => (
            ...
            >
              ...
              <div className="p-6">
                <p className="text-xs font-bold uppercase text-blue-500">{tag}</p>
