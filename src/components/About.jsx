    ...
    <main className="overflow-hidden bg-[#f7f9fc] text-[#10213f]">
      <section className="relative bg-[#0b1c38] px-5 pb-16 pt-14 text-white sm:py-24">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2">
          <div>
            <p className="text-xs font-bold uppercase tracking-[.24em] text-cyan-300"><PageText id="text_1">
              The people behind the journey
            </PageText></p>
            <h1 className="mt-6 text-4xl font-extrabold leading-[1.12] tracking-tight sm:text-6xl"><PageText id="text_2">
              More than a drive.
              </PageText><br />
              <span className="text-blue-300"><PageText id="text_3">Peace of mind.</PageText></span>
            </h1>
            <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300"><PageText id="text_4">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              ...
              ><PageText id="text_5">
                Find your service </PageText><ArrowRight size={18} />
              </Link>
              <Link
                to="/contact"
          ...
          <div className="relative rounded-[2rem] border border-white/15 bg-gradient-to-br from-blue-100 to-slate-200 p-5 shadow-2xl sm:p-8">
            ...
            <div className="mt-4 flex items-center gap-4 rounded-2xl bg-white p-5 text-[#10213f]">
              ...
              <div>
                <p className="font-extrabold"><PageText id="text_9">Your plans, our drive.</PageText></p>
                <p className="mt-1 text-sm text-slate-500"><PageText id="text_10">
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-5 py-16 sm:py-24 lg:grid-cols-[.7fr_1.3fr] lg:gap-20">
        <div>
          <p className="text-xs font-bold uppercase tracking-[.2em] text-blue-600"><PageText id="text_11">
            Our purpose
          </PageText></p>
          <h2 className="mt-4 text-3xl font-extrabold leading-tight sm:text-4xl"><PageText id="text_12">
            Less coordination.
            </PageText><br /><PageText id="text_13">
            More living.
          </PageText></h2>
        </div>
        <div>
          <p className="text-xl leading-9 text-slate-600"><PageText id="text_14">
          ...
          <p className="mt-5 leading-8 text-slate-500"><PageText id="text_15">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-16 sm:pb-24">
        <div className="mb-9 flex flex-wrap items-end justify-between gap-5">
          <div>
            <p className="text-xs font-bold uppercase tracking-[.2em] text-blue-600"><PageText id="text_16">
              Made for the way you move
            </PageText></p>
            <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl"><PageText id="text_17">
          ...
          ><PageText id="text_18">
            All services </PageText><ArrowRight size={18} />
          </Link>
        </div>
        <div className="grid gap-5 md:grid-cols-3">
          {services.map(([number, title, body, slug, Icon]) => (
            ...
            >
              ...
              <h3 className="mt-10 text-xl font-extrabold"><PageText>{title}</PageText></h3>
              <p className="mt-4 text-sm leading-7 text-slate-500"><PageText>{body}</PageText></p>
              <span className="mt-7 inline-flex items-center gap-2 text-sm font-bold text-blue-600"><PageText id="text_19">
                Explore service </PageText><ArrowRight size={16} />
              </span>
            </Link>
          ))}
        </div>
      ...
      <section className="border-y border-blue-100 bg-blue-50/60 px-5 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl">
          <p className="text-xs font-bold uppercase tracking-[.2em] text-blue-600"><PageText id="text_20">
            What matters to us
          </PageText></p>
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl"><PageText id="text_21">
          ...
          <div className="mt-10 grid gap-9 md:grid-cols-3">
            {values.map(([Icon, title, text]) => (
              <article key={title}>
                ...
                <h3 className="mt-5 text-lg font-extrabold"><PageText>{title}</PageText></h3>
                <p className="mt-3 text-sm leading-7 text-slate-600"><PageText>{text}</PageText></p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16 sm:py-24">
        <div className="flex flex-col justify-between gap-8 rounded-3xl bg-[#0b1c38] p-8 text-white sm:p-12 lg:flex-row lg:items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-[.2em] text-cyan-300"><PageText id="text_22">
              Let's get you moving
            </PageText></p>
            <h2 className="mt-4 text-3xl font-extrabold"><PageText id="text_23">
              Where will your next journey take you?
            </PageText></h2>
            <p className="mt-4 text-slate-300"><PageText id="text_24">
          ...
          ><PageText id="text_25">
            Explore & book </PageText><ArrowRight size={18} />
          </Link>
        </div>
      </section>
    </main>
