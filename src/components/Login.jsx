      ...
      <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[32px] border border-white bg-white shadow-[0_28px_80px_rgba(25,54,96,.18)] lg:grid-cols-[.9fr_1.1fr]">
        <section className="relative overflow-hidden bg-[#0a1b38] p-8 text-white sm:p-12">
          ...
          <div className="relative">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-extrabold tracking-tight">ChalakGo</span>
            </div>
            ...
            <p className="mt-5 max-w-sm leading-7 text-slate-300">
              Manage bookings, save your details, and get a smoother travel experience every time.
            </p>
            <div className="mt-10 grid gap-4 text-sm text-slate-200">
              <p className="flex items-center gap-3">
                <CheckCircle2 size={18} className="text-cyan-300" /> Verified professional drivers
              </p>
              <p className="flex items-center gap-3">
                <CheckCircle2 size={18} className="text-cyan-300" /> Password-free email OTP sign in
              </p>
              <p className="flex items-center gap-3">
                <CheckCircle2 size={18} className="text-cyan-300" /> Quick, simple booking
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <div className="flex items-center gap-2 text-sm font-bold text-blue-600">
            <LockKeyhole size={17} /> CUSTOMER LOGIN
          </div>
          ...
          <p className="mt-3 text-sm leading-6 text-slate-500">
            {isSignup
              ? 'Create your account and book your next ride with confidence.'
              : mode === 'otp'
                ? 'Enter your details once, then use email OTP to create or sign in without a password.'
          ...
          <div className="mt-7 grid gap-5">
            ...
            {(isSignup || mode === 'password' || mode === 'otp') && (
              <label className="text-sm font-bold">
                Mobile number
                <input
                  className="input"
          ...
          <p className="mt-7 text-center text-sm text-slate-500">
            {isSignup ? 'Already registered?' : 'Prefer password sign-up?'}{' '}
            <button
              type="button"
